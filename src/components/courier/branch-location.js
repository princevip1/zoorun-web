            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-10 md:py-20 '>
                ...
                <div class="mt-8">
                    <div class=" flex rounded-md border-r-0">
                        <input type="text" name="company-website" id="company-website" class="border focus:ring-green-500 focus:border-green-500 focus:border flex-1 block w-full   rounded-l sm:text-sm border-gray-300 px-5 " placeholder="Search" />
                        <span class="inline-flex items-center px-10 py-2 rounded-r-md border-l-0 border-gray-300 bg-green-600 text-gray-500 text-lg text-white"> Search</span>
                    </div>
                </div>
                <div className='bg-white mt-5 rounded '>
                    <div style={{ height: 500 }} class="flex flex-col overflow-y-auto overflow-x-hidden">
